#!/usr/bin/env python3
"""
Phase 3: Qwen2.5-VL-7B-Instruct Zero-Shot Evaluation
======================================================
Evaluates Qwen2.5-VL-7B-Instruct on all datasets using generative
...
# Batch size: Qwen2.5-VL-7B in FP16 uses ~16 GB base; with batch 16
# and image encoding, ~26 GB peak on RTX 5090 (32 GB).
EVAL_BATCH_SIZE = 16
...
def load_qwen_model(device):
    ...
    print(f"[MODEL] Loading Qwen2.5-VL: {MODEL_ID} ...")
...
def qwen_evaluate(model, processor, class_names, dataset, device,
                  desc="Qwen2.5-VL", batch_size=None, class_mapping=None):
    """Qwen2.5-VL generative zero-shot evaluation. Returns accuracy.
